...
export const rejectLeave = async (
  ...
  return customFetch<LeaveRequest>(getRejectLeaveUrl(id), {
    ...
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(rejectionAction),
  });
};
 ...
 */
export const recordParentCall = async (
  id: number,
  parentCallRecord: ParentCallRecord,
  options?: RequestInit,
): Promise<LeaveRequest> => {
  return customFetch<LeaveRequest>(getRecordParentCallUrl(id), {
    ...
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(parentCallRecord),
  });
};

export const getRecordParentCallMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type RecordParentCallMutationResult = NonNullable<
  Awaited<ReturnType<typeof recordParentCall>>
>;
 ...
 * @summary Tutor records parent call outcome
 */
export const useRecordParentCall = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
 ...
 */
export const bulkApproveLeaves = async (
  bulkApprovalInput: BulkApprovalInput,
  options?: RequestInit,
  ...
  return customFetch<BulkApprovalResult>(getBulkApproveLeavesUrl(), {
    ...
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(bulkApprovalInput),
  });
};

export const getBulkApproveLeavesMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type BulkApproveLeavesMutationResult = NonNullable<
  Awaited<ReturnType<typeof bulkApproveLeaves>>
>;
 ...
 */
export const getSimilarLeaveGroups = async (
  options?: RequestInit,
): Promise<SimilarLeaveGroup[]> => {
...
export const getGetSimilarLeaveGroupsQueryKey = () => {
  return [`/api/leaves/similar-groups`] as const;
};

export const getGetSimilarLeaveGroupsQueryOptions = <
  TData = Awaited<ReturnType<typeof getSimilarLeaveGroups>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
    Awaited<ReturnType<typeof getSimilarLeaveGroups>>,
    TError,
    TData
  >;
  request?: SecondParameter<typeof customFetch>;
  ...
  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getSimilarLeaveGroups>>
  > = ({ signal }) => getSimilarLeaveGroups({ signal, ...requestOptions });
...
export type GetSimilarLeaveGroupsQueryResult = NonNullable<
  Awaited<ReturnType<typeof getSimilarLeaveGroups>>
>;
...
export function useGetSimilarLeaveGroups<
  TData = Awaited<ReturnType<typeof getSimilarLeaveGroups>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
...
export const getListOutpassesUrl = (params?: ListOutpassesParams) => {
  ...
  return stringifiedParams.length > 0
    ? `/api/outpasses?${stringifiedParams}`
    : `/api/outpasses`;
};
 ...
 */
export const listOutpasses = async (
  params?: ListOutpassesParams,
  options?: RequestInit,
): Promise<Outpass[]> => {
...
export const getListOutpassesQueryKey = (params?: ListOutpassesParams) => {
  return [`/api/outpasses`, ...(params ? [params] : [])] as const;
};

export const getListOutpassesQueryOptions = <
  TData = Awaited<ReturnType<typeof listOutpasses>>,
  TError = ErrorType<unknown>,
>(
  params?: ListOutpassesParams,
  options?: {
    query?: UseQueryOptions<
      Awaited<ReturnType<typeof listOutpasses>>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof customFetch>;
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof listOutpasses>>> = ({
    signal,
  }) => listOutpasses(params, { signal, ...requestOptions });
...
export type ListOutpassesQueryResult = NonNullable<
  Awaited<ReturnType<typeof listOutpasses>>
>;
...
export function useListOutpasses<
  TData = Awaited<ReturnType<typeof listOutpasses>>,
  TError = ErrorType<unknown>,
>(
  params?: ListOutpassesParams,
...
export const getGetOutpassQueryKey = (id: number) => {
  return [`/api/outpasses/${id}`] as const;
};

export const getGetOutpassQueryOptions = <
  TData = Awaited<ReturnType<typeof getOutpass>>,
  TError = ErrorType<void>,
>(
  id: number,
  options?: {
    query?: UseQueryOptions<
      Awaited<ReturnType<typeof getOutpass>>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof customFetch>;
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getOutpass>>> = ({
    signal,
  }) => getOutpass(id, { signal, ...requestOptions });
...
export type GetOutpassQueryResult = NonNullable<
  Awaited<ReturnType<typeof getOutpass>>
>;
...
export const getLookupOutpassUrl = (params?: LookupOutpassParams) => {
  ...
  return stringifiedParams.length > 0
    ? `/api/outpasses/lookup?${stringifiedParams}`
    : `/api/outpasses/lookup`;
};

/**
 * @summary Security lookup outpass by outpassCode, registerNumber, or studentName
 */
export const lookupOutpass = async (
  params?: LookupOutpassParams,
  options?: RequestInit,
): Promise<Outpass[]> => {
...
export const getLookupOutpassQueryKey = (params?: LookupOutpassParams) => {
  return [`/api/outpasses/lookup`, ...(params ? [params] : [])] as const;
};

export const getLookupOutpassQueryOptions = <
  TData = Awaited<ReturnType<typeof lookupOutpass>>,
  TError = ErrorType<unknown>,
>(
  params?: LookupOutpassParams,
  options?: {
    query?: UseQueryOptions<
      Awaited<ReturnType<typeof lookupOutpass>>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof customFetch>;
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof lookupOutpass>>> = ({
    signal,
  }) => lookupOutpass(params, { signal, ...requestOptions });
...
export type LookupOutpassQueryResult = NonNullable<
  Awaited<ReturnType<typeof lookupOutpass>>
>;
...
export function useLookupOutpass<
  TData = Awaited<ReturnType<typeof lookupOutpass>>,
  TError = ErrorType<unknown>,
>(
  params?: LookupOutpassParams,
 ...
 */
export const verifyOutpass = async (
  id: number,
  outpassVerifyInput: OutpassVerifyInput,
  options?: RequestInit,
): Promise<Outpass> => {
  return customFetch<Outpass>(getVerifyOutpassUrl(id), {
    ...
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(outpassVerifyInput),
  });
};

export const getVerifyOutpassMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type VerifyOutpassMutationResult = NonNullable<
  Awaited<ReturnType<typeof verifyOutpass>>
>;
...
export const getRecordReturnMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type RecordReturnMutationResult = NonNullable<
  Awaited<ReturnType<typeof recordReturn>>
>;
...
export const listNotificationLogs = async (
  ...
  return customFetch<NotificationLog[]>(getListNotificationLogsUrl(), {
    ...options,
    method: "GET",
  });
};
...
export const getListNotificationLogsQueryKey = () => {
  return [`/api/notifications/logs`] as const;
};
...
>(options?: {
  ...
  const queryKey = queryOptions?.queryKey ?? getListNotificationLogsQueryKey();

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof listNotificationLogs>>
  > = ({ signal }) => listNotificationLogs({ signal, ...requestOptions });
...
>(options?: {
  ...
  const queryOptions = getListNotificationLogsQueryOptions(options);
...
export const getGetHostelOccupancyQueryOptions = <
  TData = Awaited<ReturnType<typeof getHostelOccupancy>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
    Awaited<ReturnType<typeof getHostelOccupancy>>,
    TError,
    TData
  >;
  request?: SecondParameter<typeof customFetch>;
  ...
  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getHostelOccupancy>>
  > = ({ signal }) => getHostelOccupancy({ signal, ...requestOptions });
...
export type GetHostelOccupancyQueryResult = NonNullable<
  Awaited<ReturnType<typeof getHostelOccupancy>>
>;
...
export function useGetHostelOccupancy<
  TData = Awaited<ReturnType<typeof getHostelOccupancy>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
...
export const getGetMonthlyReportUrl = (params?: GetMonthlyReportParams) => {
  ...
  return stringifiedParams.length > 0
    ? `/api/dashboard/monthly-report?${stringifiedParams}`
...
export const getGetStudentsOutsideQueryKey = () => {
  return [`/api/dashboard/students-outside`] as const;
};

export const getGetStudentsOutsideQueryOptions = <
  TData = Awaited<ReturnType<typeof getStudentsOutside>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
    Awaited<ReturnType<typeof getStudentsOutside>>,
    TError,
    TData
  >;
  request?: SecondParameter<typeof customFetch>;
  ...
  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getStudentsOutside>>
  > = ({ signal }) => getStudentsOutside({ signal, ...requestOptions });
...
export type GetStudentsOutsideQueryResult = NonNullable<
  Awaited<ReturnType<typeof getStudentsOutside>>
>;
...
export function useGetStudentsOutside<
  TData = Awaited<ReturnType<typeof getStudentsOutside>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
